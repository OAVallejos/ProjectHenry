...
def obtener_informacion_desarrollador(data_games, id=None):
    ...
    if id is not None:
        ...
        juegos_del_desarrollador = juegos_gratuitos[juegos_gratuitos['id'] == id]
        ...
        return {}  # Devolver un diccionario vacío si no se proporciona un ID
...
async def obtener_resultados(id: int = None):
    resultado = obtener_informacion_desarrollador(data_games, id)
    if resultado:
        return resultado
    else:
